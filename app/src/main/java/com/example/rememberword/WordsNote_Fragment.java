...
public class WordsNote_Fragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ArrayAdapter<String> adapter=new ArrayAdapter<String>(this.getActivity(),android.R.layout.simple_spinner_item,initLessons());
		...
		startButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				i.putExtras(mBundle);				
				i.setClass(mContext, WordsNote_Activity.class);
		...
		mTextView.setText(Config.init().getCurrentUseDictName()+" "+
				Config.init().getCurrentUseDictWordCount()+"词 "+
				"共"+Config.init().getLessonCount()+"课,每课"+
				Config.init().getEachLessonWordCount()+"词");
